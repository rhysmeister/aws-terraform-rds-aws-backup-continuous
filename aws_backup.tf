...
resource "aws_backup_plan" "rds_backup_plan_hourly_continuous" {
    name                     = "rds-backup-plan-hourly-continuous"

    rule {
        rule_name                = "rds-backup-plan-hourly-continuous"
...
resource "aws_backup_selection" "rds_backup_selection" {
    ...
    plan_id      = aws_backup_plan.rds_backup_plan_hourly_continuous.id
